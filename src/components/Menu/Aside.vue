<template>
  <div id="sidebar" :class="{ active: IsActive }">
    ...
    <ul>
      <li>
        <router-link :to="{ name: 'Home' }"> <img src="@/assets/petshop.jpg" alt="Logo Fazt" class="logo" /></router-link>
      </li>
      <li>
        <h3>Categorías</h3>
      </li>
      <li class="liLinks" v-for="categoria in dataCategoria" :key="categoria.id">
        <router-link
          class="links"
          :to="{
            name: 'Content',
