<template>
  <div>
    ...
    <div class="row">
      <div class="col-12">
        <b>Nombre Producto: </b><span>{{ producto.dataModal.dataProducto.name }}</span>
      </div>
    </div>
    <div class="compra row flex-row">
      <div class="col-3">
        <b>Precio: </b>
      ...
      <div class="col-4">
        <div class="d-flex mb-2">
          <button @click="minus" :disabled="producto.dataModal.cantidadProductos <= 0">
            <b-iconstack font-scale="1">
              <b-icon stacked icon="cart-dash" variant=""></b-icon>
            </b-iconstack>
          </button>
          <input class="quantity w-25" min="0" name="quantity" v-model="producto.dataModal.cantidadProductos" type="number" readonly />
          <button @click="plus" :disabled="producto.dataModal.cantidadProductos >= producto.dataModal.dataProducto.stock">
            <b-iconstack font-scale="1">
...
export default {
  ...
  computed: {
    subTotal() {
      return this.producto.dataModal.cantidadProductos * this.producto.dataModal.dataProducto.price;
    },
  },
  methods: {
    minus() {
    ...
    subTotalResult() {
      this.subTotalData = this.producto.dataModal.cantidadProductos * this.producto.dataModal.dataProducto.price;
    },
    ...mapActions("Carrito", {
